...
Widget pinChangedErrorView({required String iconPath, required String title, required String text, required VoidCallback onPressed}){
  return Container(
      ...
      children: [
        ...
        SizedBox(
            ...
            child: submitButton(onPressed: () {
              onPressed();
            }, text: "Login Again", disabled: false)),
      ],
    ),
  );
}