...
import 'package:fantasy/features/home/presentation/screens/player_choice_bench_screen.dart';
...
class CreateTeamScreen extends StatefulWidget {
  ...
  CreateTeamScreen({required this.createTeamModel});

  @override
  State<CreateTeamScreen> createState() => _CreateTeamScreenState();
}

class _CreateTeamScreenState extends State<CreateTeamScreen> with TickerProviderStateMixin {
                    ...
                    Expanded(
                      child: ElevatedButton(
                          onPressed: data.selectedPlayers.length != 15 ? null : (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => PlayerChoiceBenchScreen(createTeamModel: widget.createTeamModel,)));
                          },
