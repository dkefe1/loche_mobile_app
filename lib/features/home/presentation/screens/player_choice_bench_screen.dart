...
import 'package:fantasy/features/home/presentation/screens/player_choice_captains_screen.dart';
import 'package:fantasy/features/home/presentation/widgets/player_choice_bench_component.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class PlayerChoiceBenchScreen extends StatelessWidget {

  CreateTeamModel createTeamModel;
  PlayerChoiceBenchScreen({required this.createTeamModel});
                    ...
                    Expanded(
                      child: ElevatedButton(
                          onPressed: data.substitutePlayers.length != 4 ? null : (){
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (context) => PlayerChoiceCaptainsScreen(createTeamModel: createTeamModel,)));
                          },
                          style: ElevatedButton.styleFrom(
