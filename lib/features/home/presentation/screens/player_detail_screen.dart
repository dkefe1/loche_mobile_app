...
class PlayerDetailScreen extends StatefulWidget {
  ...
  PlayerDetailScreen({super.key, required this.clientPlayer});
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              clientPlayerComponent(label: "Chance Created", value: switched ? widget.clientPlayer.stat!.chancecreated! : widget.clientPlayer.chancecreated),
                              switched ? yesOrNoClientPlayerComponent(label: "Starting", value: widget.clientPlayer.stat!.starting11!) : clientPlayerComponent(label: "Starting", value: widget.clientPlayer.starting),
                              switched ? yesOrNoClientPlayerComponent(label: "Substitute", value: widget.clientPlayer.stat!.substitute!) : clientPlayerComponent(label: "Substitute", value: widget.clientPlayer.substitute),
