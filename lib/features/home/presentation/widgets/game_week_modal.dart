...
Widget gameWeekModalSheet({required BuildContext context, required, required String? gameWeekId}) {
  ...
  return BlocConsumer<JoinedGameWeekBloc, JoinedGameWeekState>(
    ...
    if (state is GetJoinedGameWeekSuccessfulState) {
      return state.joinedGameWeeks.isEmpty
          ? notJoinedGameWeek()
          : gameWeekModalBody(joinedGameWeeks: state.joinedGameWeeks, gameWeekId: gameWeekId, context: context);
...
Widget gameWeekModalBody({required List<ClientGameWeekTeam> joinedGameWeeks, required String? gameWeekId, required BuildContext context}) {
    ...
    child: SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Text(
            AppLocalizations.of(context)!.select_a_gw,
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
                ...
                return GestureDetector(
                  onTap: () {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => JoinedGameWeekScreen(
                                  gameWeekId:
                                      joinedGameWeeks[index].game_week_id.id,
                                )));
                  },
                  child: Container(
                    ...
                    child: Center(
                      ...
                      children: [
                        Text(
                          "GW ${joinedGameWeeks[index].game_week_id.game_week}",
...
Widget notJoinedGameWeek() {
  return Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.vertical(top: Radius.circular(60))),
      child: Text(
        "You have not joined any game week",
