...
Widget teamBuildSearchWidget({required List<EntityPlayer> searchedPlayers}) {
                  ...
                  return GestureDetector(
                    onTap: (){
                      showDialog(context: context, builder: (context) {
                        return playerDetailDialog(player: searchedPlayers[index], context: context);
                      });
                    },
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          trailing: Row(
                            ...
                            children: [
                              Text(searchedPlayers[index].price, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14),),
                              SizedBox(width: 20,),
                              data.selectedPlayers.contains(searchedPlayers[index]) ? GestureDetector(
                                onTap: () {
                                  data.removePlayer(searchedPlayers[index]);
                                  data.increaseCredit(double.parse(searchedPlayers[index].price));
                                },
                                child: Container(
                                  width: 30,
                                  height: 30,
