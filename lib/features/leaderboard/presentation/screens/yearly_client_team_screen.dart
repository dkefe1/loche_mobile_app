...
class YearlyClientTeamScreen extends StatefulWidget {

  Leaderboard contestor;
  YearlyClientTeamScreen({super.key, required this.contestor});

  @override
  State<YearlyClientTeamScreen> createState() => _YearlyClientTeamScreenState();
}

class _YearlyClientTeamScreenState extends State<YearlyClientTeamScreen> {
              ...
              if (state is GetOtherClientTeamSuccessfulState) {
                ...
                return errorView(
                    ...
                    onPressed: () {
                      ...
                      getPlayers.add(GetOtherClientTeamEvent(widget.contestor.client_id.id));
                    });
              } else {
                return SizedBox();
              }
