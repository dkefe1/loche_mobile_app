...
Widget myRankContainer({required MyRank contestor}) {
  return Container(
    ...
    child: ListTile(
      ...
      title: Text("${contestor.client_id.first_name} ${contestor.client_id.last_name}", style: TextStyle(color: textBlackColor, fontSize: 14, fontWeight: FontWeight.w500),),
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
